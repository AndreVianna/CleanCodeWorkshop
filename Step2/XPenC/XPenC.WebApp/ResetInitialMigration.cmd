...
dotnet ef database drop --force --context XPenC.WebApp.Data.DataContext
if NOT %errorlevel% == 0 goto :Error
echo [93mRemove current Initial migration...[0m
dotnet ef migrations remove --context XPenC.WebApp.Data.DataContext
if NOT %errorlevel% == 0 goto :Error
echo [93mCreating new Initial migration...[0m
dotnet ef migrations add Initial --context XPenC.WebApp.Data.DataContext
if NOT %errorlevel% == 0 goto :Error
echo [93mUpdating database...[0m
dotnet ef database update --context XPenC.WebApp.Data.DataContext
if NOT %errorlevel% == 0 goto :Error
